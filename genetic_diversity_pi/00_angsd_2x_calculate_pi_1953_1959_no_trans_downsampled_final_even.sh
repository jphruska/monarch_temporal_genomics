#!/bin/bash
#SBATCH --chdir=./
#SBATCH --job-name=angsd_2x_pi_1953_1959_calc_pi_no_trans_downsampled_final_even
#SBATCH --partition batch
#SBATCH --nodes=1 --ntasks=4
#SBATCH --time=48:00:00
#SBATCH --mem-per-cpu=10G
#SBATCH -o /work/sonsthagen/johruska/monarchs/scripts/genetic_diversity_pi/logs/angsd_2x_calculate_pi_1953_1959_no_trans_downsampled_final_even/%j.out
...
${workdir}/2x_1953_1959.saf.saf.idx \
-outname ${workdir}/2x_1953_1959 \
-sfs ${workdir}/2x_1953_1959.saf.saf.sfs.folded.trimmed \
-fold 1 
 
# run thetastat
${angsd_dir}/thetaStat do_stat \
${workdir}/2x_1953_1959.thetas.idx
