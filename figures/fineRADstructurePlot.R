...
setwd("~/Desktop/monarchs/finestructure/un-thinned/sorted_2/") ## The directory where the files are located
chunkfile<-"./monarch_finestructure_linked.chunkcounts.out" ## RADpainter output file
mcmcfile<-"./monarch_finestructure_linked_mcmc.xml" ## finestructure mcmc file
treefile<-"./stage4/monarch_finestructure_linked_tree.xml" ## finestructure tree file
### 2) EDIT THIS PATH TO WHERE YOU WANT THE PLOTS:
plotsFolder <- "~/Desktop/monarchs/finestructure/un-thinned/sorted_2/"
### 3) SET VALUES FOR THESE VARIABLES: "analysisName" will be included in output plots
analysisName <- "INPUT_FILE";  maxIndv <- 4000; maxPop <- 4000


### 4) EDIT THE PATH TO YOUR COPY of FinestructureLibrary.R
source("~/Desktop/monarchs/finestructure/un-thinned/sorted_2/FinestructureLibrary.R", chdir = TRUE) # read in the R functions, which also calls the needed packages
